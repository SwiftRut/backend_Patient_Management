...
export const createmedicalrecord = async (req, res) => {
    try {
        ...
        const data = await prescriptionModel.findById({ doctorId: req.user._id }).populate("patientId" , "doctorId" , "prescriptionId" , "appointmentId")
...
export const getMedicalRecords = async (req, res) => {
    try {
      const medicalRecords = await medicalRecordModel.find().populate('patientId doctorId prescriptionId appointmentId');
  ...
  export const getMedicalRecordById = async (req, res) => {
    try {
      const medicalRecord = await medicalRecordModel.findById(req.params.id).populate('patientId doctorId prescriptionId appointmentId');
