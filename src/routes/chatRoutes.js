...
router.get('/contacts/patient/:patientId',protect,cacheMiddleware,getDoctorContacts);
router.get('/contacts/doctor/:doctorId',protect,cacheMiddleware, getPatientContacts);
